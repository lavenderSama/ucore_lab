...
lab1-ex1:     file format elf64-x86-64
...
0000000000400274 <.note.gnu.build-id>:
  ...
  400285:	30 41 86             	xor    %al,-0x7a(%rcx)
  400288:	d1 01                	roll   (%rcx)
  40028a:	ed                   	in     (%dx),%eax
  40028b:	ac                   	lods   %ds:(%rsi),%al
  40028c:	38 b3 76 cc 63 3f    	cmp    %dh,0x3f63cc76(%rbx)
  400292:	44                   	rex.R
  400293:	36                   	ss
  400294:	d0 d3                	rcl    %bl
  400296:	d3 22                	shll   %cl,(%rdx)
...
00000000004005c0 <_IO_stdin_used>:
  ...
  4005c4:	68 65 6c 6c 6f       	pushq  $0x6f6c6c65
  4005c9:	20 77 6f             	and    %dh,0x6f(%rdi)
...
00000000004005d0 <.eh_frame_hdr>:
  4005d0:	01 1b                	add    %ebx,(%rbx)
  4005d2:	03 3b                	add    (%rbx),%edi
  4005d4:	34 00                	xor    $0x0,%al
  4005d6:	00 00                	add    %al,(%rax)
  4005d8:	05 00 00 00 30       	add    $0x30000000,%eax
  4005dd:	fe                   	(bad)  
  4005de:	ff                   	(bad)  
  4005df:	ff 80 00 00 00 70    	incl   0x70000000(%rax)
  4005e5:	fe                   	(bad)  
  4005e6:	ff                   	(bad)  
  ...
  4005ed:	ff                   	(bad)  
  4005ee:	ff                   	(bad)  
  4005ef:	ff a8 00 00 00 70    	ljmpq  *0x70000000(%rax)
  4005f5:	ff                   	(bad)  
  4005f6:	ff                   	(bad)  
